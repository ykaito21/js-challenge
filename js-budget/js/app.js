class UI {
  ...
  submitBudgetForm() {
    ...
    if (value === "" || value < 0) {
      ...
      this.budgetFeedback.textContent = "Budget cannot be empty or negative";
      const self = this;
      setTimeout(() => {
  ...
  submitExpenseForm() {
    ...
    if (expenseValue === "" || amountValue === "" || amountValue < 0) {
      ...
      this.expenseFeedback.textContent = "Expense cannot be empty or negative";
      const self = this;
      setTimeout(() => {
      ...
      let expense = { id: this.itemID, title: expenseValue, amount: amount };
      this.itemID++;
